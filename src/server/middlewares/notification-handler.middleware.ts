...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['business-owner', 'outlet-manager', 'sales-associate', 'customer-service-representative'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
  'FeedbackCreated.create': {
    roles: ['business-owner', 'outlet-manager', 'sales-associate', 'customer-service-representative'],
    key: 'feedback',
    tenantPath: [],
    userPath: [],
...
const ownerRoles: string[] = ['customer-service-representative'];
